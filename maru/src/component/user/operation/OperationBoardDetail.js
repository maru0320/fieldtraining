...
const OperationBoardDetail = () => {
  ...
  const fetchBoardDetail = useCallback(async () => {
    try {
      const response = await axiosInstance.get(
        `/operation/detail?boardID=${boardID}`
      );
  ...
  const deleteBoard = async () => {
    try {
      await axiosInstance.get(
        `/operation/detail/delete?boardID=${boardID}`
      );
      alert("게시글이 삭제되었습니다!");
      navigate("/Operation");
    } catch (error) {
  ...
  const createComment = async () => {
    try {
      await axiosInstance.post("/operation/detail/commentWrite", {
        boardID: boardID,
  ...
  const deleteComment = async (commentID) => {
    try {
      await axiosInstance.get(
        `/operation/detail/commentDelete?commentID=${commentID}`
      );
      alert("댓글이 삭제되었습니다!");
      fetchBoardDetail();
    } catch (error) {
