...
public class GalleryController {
    ...
    public ResponseEntity<Page<GalleryDetailDto>> getPagedGalleries(
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "12") int size) {
        Page<GalleryDetailDto> pagedGalleries = galleryService.getPagedGalleries(page, size);
        return ResponseEntity.ok(pagedGalleries);
    }
