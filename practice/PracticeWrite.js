...
import "./PracticeWrite.css"; // 스타일링을 위한 CSS 파일 추가
...
const PracticeWrite = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("writerID", 1); // 임시로 작성자 ID를 1로 설정
    ...
    try {
      const response = await axios.post("http://localhost:8090/practice/write", formData, {
        headers: {
